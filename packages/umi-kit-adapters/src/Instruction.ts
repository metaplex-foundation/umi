...
import { AccountRole, IInstruction as KitInstruction } from "@solana/instructions";
 ...
 */
export function fromKitInstruction(kitInstruction: KitInstruction): Instruction {
    return {
        ...
        data: kitInstruction.data instanceof Uint8Array ? kitInstruction.data : new Uint8Array(),
    };
}
